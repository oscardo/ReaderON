...
export type AppMode = 'HOME' | 'CAPTURE' | 'PRACTICE' | 'ANALYSIS' | 'HISTORY' | 'STUDY' | 'EBOOKS' | 'EBOOK_DETAIL' | 'PHONETICS' | 'COGNATES' | 'SUAVE' | 'TRANSLATOR' | 'THOUSAND_WORDS' | 'THOUSAND_WORDS_2' | 'REGULAR_VERBS' | 'IRREGULAR_VERBS' | 'IDIOMS' | 'C1_ESSENCIAL' | 'C1_WORDS' | 'SLANG' | 'PHRASAL_VERBS_MENU' | 'PHRASAL_VERBS' | 'PHRASAL_VERBS_UP_OUT' | 'PHRASAL_VERBS_OFF' | 'PHRASAL_VERBS_ON' | 'PHRASAL_VERBS_IN' | 'PHRASAL_VERBS_BACK' | 'PHRASAL_VERBS_THROUGH';
